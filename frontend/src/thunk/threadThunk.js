...
export const createThreadAsync = createAsyncThunk(
  ...
  async (threadData) => {
    ...
    const response = await axios.post('https://furfinder-server.onrender.com/thread', formData);
...
export const getThreadAsync = createAsyncThunk(
  'thread/get',
  async (threadId) => {
    const response = await axios.get(`https://furfinder-server.onrender.com/thread/${threadId}`);
...
export const deleteThreadAsync = createAsyncThunk(
  'thread/delete',
  async (threadId) => {
    await axios.delete(`https://furfinder-server.onrender.com/thread/${threadId}`);
    return threadId;
  }
);
...
export const updateThreadAsync = createAsyncThunk(
  ...
  async ({ threadId, updateData }) => {
    ...
    const response = await axios.put(`https://furfinder-server.onrender.com/thread/${threadId}`, updateData);
